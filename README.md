...
-   Seed for the database with real skills data [DONE]
...
-   Retrieve character list and individual character pages via API [DONE]
-   Page displaying the list of characters [DONE]
